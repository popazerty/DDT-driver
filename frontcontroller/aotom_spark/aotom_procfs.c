...
static int vfd_write(struct file *file, const char __user *buf, unsigned long count, void *data)
{
	char *page;
	int value;
	int ret = -ENOMEM;
		...
		if (aotomGetVersion() != YWPANEL_FP_DISPTYPE_LED)
		{
			...
			if (aotomGetVersion() == YWPANEL_FP_DISPTYPE_VFD)
			{
				if ((progress > 0) && (progress <= 98) && (led_state[LED_SPINNER].period == 0))
								 // start spinner
					flashLED(LED_SPINNER, 200);
				if ((progress > 98) && (led_state[LED_SPINNER].period > 0))
								 // stop spinner
					flashLED(LED_SPINNER, 0);
			}
		}
		else
		{
...
static int lcd_symbol_usb_write(struct file *file, const char __user *buf, unsigned long count, void *data)
{
	char *page;
	long value;
	int ret = -ENOMEM;
...
static int lcd_symbol_hdd_write(struct file *file, const char __user *buf, unsigned long count, void *data)
{
	char *page;
	long value;
	int ret = -ENOMEM;
...
static int lcd_symbol_hddprogress_write(struct file *file, const char __user *buf, unsigned long count, void *data)
{
	char *page;
	long value;
	int ret = -ENOMEM;
...
static int lcd_symbol_signal_write(struct file *file, const char __user *buf, unsigned long count, void *data)
{
	char *page;
	long value;
	int ret = -ENOMEM;
...
static int lcd_symbol_timeshift_write(struct file *file, const char __user *buf, unsigned long count, void *data)
{
	char *page;
	long value;
	int ret = -ENOMEM;
...
static int lcd_symbol_tv_write(struct file *file, const char __user *buf, unsigned long count, void *data)
{
	char *page;
	long value;
	int ret = -ENOMEM;
...
static int lcd_symbol_record_1_write(struct file *file, const char __user *buf, unsigned long count, void *data)
{
	char *page;
	long value;
	int ret = -ENOMEM;
...
static int lcd_symbol_record_2_write(struct file *file, const char __user *buf, unsigned long count, void *data)
{
	char *page;
	long value;
	int ret = -ENOMEM;
...
static int lcd_symbol_smartcard_write(struct file *file, const char __user *buf, unsigned long count, void *data)
{
	char *page;
	long value;
	int ret = -ENOMEM;
...
static int lcd_symbol_play_write(struct file *file, const char __user *buf, unsigned long count, void *data)
{
	char *page;
	long value;
	int ret = -ENOMEM;
